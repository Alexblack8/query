								...
								<p>
						       	...
						       	<form action="" method="post" >
									<div class="form-group">						
							       		...
							       		<button type="submit" class="btn btn-link" name="like"><span class="glyphicon glyphicon-thumbs-up"></span></button>		       	
							       		<button type="submit" class="btn btn-link" name="dislike"><span class="glyphicon glyphicon-thumbs-down glyphicon-lg"></span></button>
						   			</div>
						       	</form>	</div>					     
							</div>					
